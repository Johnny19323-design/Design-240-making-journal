...
The artificial intelligence defaulted to using familiar data graphics to present the dataset. It generated different charts to visualise the data, which was useful, but the outputs leaned toward standard chart logic rather than more experimental or audience-specific design forms. This suggests that when asked to visualise data, the tool tends to prioritise recognisable analytical formats first.

### What did I have to override or redirect?

I had to redirect the artificial intelligence away from only producing standard graphs. I also had to ask it to change the format and presentation style because it did not initially generate the kinds of representations I wanted. In particular, I needed to push it toward code-based, textual, and analogue ideas rather than accepting the first chart-based outputs.

### What assumptions did the AI make about the data or the audience?

The artificial intelligence seemed to assume that the dataset should be understood mainly through quantifiable categories such as animals, numbers, regions, campsite categories, and other clearly countable variables. It also seemed to assume an audience that wanted a clear summary rather than a more imaginative or critical engagement with the data. This meant the outputs often felt informative, but not especially reflective or culturally situated.
...
If I were building this without artificial intelligence, I would first spend more time researching existing representation styles and data visualisation methods before choosing the most suitable one for the dataset. Then I would develop a representation based more strongly on my own design intentions rather than beginning from the artificial intelligence’s default outputs. Artificial intelligence was useful for speed and idea generation, but without it I think the process would be slower and more deliberate from the beginning.

## Reflection

This independent study showed me that artificial intelligence is useful for **exploration**, but not necessarily for producing finished design outcomes without strong direction. Gemini helped me understand the structure of the dataset very quickly and generated several possible representations, which saved time and made it easier to see multiple directions. At the same time, its outputs were often generic, and I had to keep redirecting it when I wanted something more specific or less conventional.

One important insight from **Data Feminism** is that data is never neutral and that visualisation choices shape whose experiences become visible. This raises useful questions for my dataset. The DOC Campsites data may seem practical and objective, but it still reflects institutional categories and priorities. It records campsites as entries with measurable features, but it does not represent all the social, cultural, or environmental dimensions of camping, land use, or public access. This reminds me that artificial intelligence can make a dataset easier to process, but it can also make it even easier to overlook what is missing.
...
Overall, my experience of working with artificial intelligence as a design tool was mixed but valuable. It was very effective for quickly understanding the CSV, identifying patterns, and producing multiple starting points. However, it was less effective when I wanted more resolved, specific, or original design outcomes. The process taught me that artificial intelligence works best when treated as something to question, redirect, and critique rather than simply obey. With more time, I would like to develop one of the non-chart representations further, especially a website-based or interactive version that could connect campsite data to a more exploratory user experience.
